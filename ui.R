  ...
  header = tagList(
    ...
    tags$head(
      ...
      tags$style(HTML("
              ...
              .navbar{display:block !important;overflow:hidden !important;width:100% !important; background-color: #CC5500 !important;}  /* 导航栏宽度限制 */
              body{padding-top:70px !important;}  /* 顶部留白 */
              
              .navbar-brand:hover {color: #006666 !important; /* 悬停时标题文字颜色：青蓝色 */}
              .navbar-nav > li > a:hover { color: #006666 !important; /* 悬停文字颜色：青蓝色 */ background-color: #CC5500 !important; /* 悬停背景颜色：深青灰色 */}
              .nav-pills > li.active > a {background-color: #CC5500 !important; /* 激活选项卡背景颜色：深青灰色 */}
