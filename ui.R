  ...
  header = tagList(
    ...
    tags$head(
      ...
      tags$style(HTML("
              ...
              .navbar-brand:hover {color: #00CED1 !important; /* 悬停时标题文字颜色：青蓝色 */}
              .navbar-nav > li > a:hover { color: #00CED1 !important; /* 悬停文字颜色：青蓝色 */ background-color: #2F4F4F !important; /* 悬停背景颜色：深青灰色 */}
              .nav-pills > li.active > a {background-color: #2F4F4F !important; /* 激活选项卡背景颜色：深青灰色 */}
